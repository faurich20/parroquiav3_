...
#             revoked=False  # 🔧 Agregado correctamente (antes faltaba coma)
#         )
...
#         # 🔧 Revocar todos los refresh tokens activos del usuario al hacer logout
